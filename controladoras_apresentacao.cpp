...
void CtrlIATeste::executar(Matricula matricula) {
    ...
    while (apresentar) {     // Apresenta tela inicial.
        ...
        switch (opcao) {
            case VISUALIZAR:
                comando = new ComandoIATesteVisualizar(matricula);
                comando->executar(ctrlISTeste);
                delete comando;
                break;

            case CADASTRAR:
                comando = new ComandoIATesteCadastrar(matricula);
                comando->executar(ctrlISTeste);
                delete comando;
                break;

            case EDITAR:
                comando = new ComandoIATesteEditar(matricula);
                comando->executar(ctrlISTeste);
                delete comando;
                break;

            case DESCADASTRAR:
                comando = new ComandoIATesteDescadastrar(matricula);
                comando->executar(ctrlISTeste);
                delete comando;
                break;
...
void CtrlIACasoDeTeste::executar(Matricula matricula) {
    ...
    while (apresentar) {     // Apresenta tela inicial.
        ...
        switch (opcao) {
            case VISUALIZAR:
                comando = new ComandoIACasoDeTesteVisualizar(matricula);
            ...
            case CADASTRAR:
                ...
                comando = new ComandoIACasoDeTesteCadastrar(matricula);
                comando->executar(ctrlISCasoDeTeste);
                delete comando;
                break;

            case EDITAR:
                comando = new ComandoIACasoDeTesteEditar(matricula);
                comando->executar(ctrlISCasoDeTeste);
                delete comando;
                break;

            case DESCADASTRAR:
                comando = new ComandoIACasoDeTesteDescadastrar(matricula);
                comando->executar(ctrlISCasoDeTeste);
                delete comando;
                break;
